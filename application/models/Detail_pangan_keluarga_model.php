...
class Detail_pangan_keluarga_model extends CI_Model
{
    ...
    function json($pangan) {
        $this->datatables->select('detail_pangan_keluarga.id,detail_pangan_keluarga.urt,takaran,berat,asal,rata_rata_berat,pangan.nama');
        ...
        $this->datatables->add_column('action',anchor(site_url('detail_pangan_keluarga/update/$1/'.$pangan),'Ubah')." | ".anchor(site_url('detail_pangan_keluarga/delete/$1/'.$pangan),'Hapus','onclick="javasciprt: return confirm(\'Apakah Anda Yakin ?\')"'), 'id');
