...
class Detail_pangan_keluarga_model extends CI_Model
{
    ...
    function json($pangan) {
        ...
        $this->datatables->add_column('action',anchor(site_url('detail_pangan_keluarga/update/$1/'.$pangan),'Update')." | ".anchor(site_url('detail_pangan_keluarga/delete/$1/'.$pangan),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id');
