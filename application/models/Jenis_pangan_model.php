...
class Jenis_pangan_model extends CI_Model
{
    ...
    function json() {
        ...
        $this->datatables->add_column('action', anchor(site_url('jenis_pangan/read/$1'),'Read')." | ".anchor(site_url('jenis_pangan/update/$1'),'Update')." | ".anchor(site_url('jenis_pangan/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id');
