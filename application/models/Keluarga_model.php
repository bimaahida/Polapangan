...
class Keluarga_model extends CI_Model
{
    ...
    function json() {
        ...
        $this->datatables->add_column('action', anchor(base_url('pangan_keluarga/data_pangan/$1'),'Pangan')." | ".anchor(base_url('user_keluarga/index/$1'),'Anggota')." | ".anchor(site_url('keluarga/update/$1'),'Update')." | ".anchor(site_url('keluarga/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id');
