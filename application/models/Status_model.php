...
class Status_model extends CI_Model
{
    ...
    function json() {
        ...
        $this->datatables->add_column('action', anchor(site_url('status/read/$1'),'Read')." | ".anchor(site_url('status/update/$1'),'Update')." | ".anchor(site_url('status/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id');
